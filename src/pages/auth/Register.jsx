...
const Title = styled.h2`text-align: center; font-size: 1.5rem; font-weight: 700; margin-bottom: 0.25rem;`
const Sub = styled.p`
  text-align: center;
  ...
  return (
    <Page>
      <Card>
        ...
        <Sub>Join the community. Create & attend tech events.</Sub>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Btn type="submit" disabled={loading}>{loading ? 'Creating account...' : 'Join the Community'}</Btn>
        </form>
